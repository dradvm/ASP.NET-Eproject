...
values
	...
	('Hwansaenggo.webp', 'Hwansaenggo Serum Infused Foaming Cleanser 150ml'),
	('MDV-107-1A3V.webp', 'Genuine Men''s CASIO Watch MDV-107-1A3'),
...
values
	...
	(1, 1, 'The Face Shop', '85ba6666-85aa-43a5-8c30-a474210a6c38.webp', 'The Face Shop Vietnam was born with the mission of bringing premium, quality, genuine products in the field of skin care and makeup to dynamic, modern, and caring Vietnamese women. Take care of your beauty.'),
	(1, 2, 'Casio', 'logo_casio_g_store.webp', 'Casio Computer Co., Ltd. is a Japanese multinational electronics manufacturing corporation headquartered in Shibuya, Tokyo, Japan. Its products include calculators, mobile phones, digital cameras, electronic musical instruments, and analogue and digital watches. It was founded in 1946, and in 1957 introduced the first entirely compact electronic calculator. It was an early digital camera innovator, and during the 1980s and 1990s, the company developed numerous affordable home electronic keyboards for musicians along with introducing the first mass-produced digital watches.'),
	(1, 1, 'PNJ', 'pnj.webp', 'Every story has a beginning. Starting from Phu Nhuan Jewelry store in 1988 and now in 2021, PNJ has grown to become one of the leading corporations in the field of professional jewelry production and business.'),
...
values
	...
	(2, 'Hwansaenggo Serum Infused Foaming Cleanser 150ml', 'Hwansaenggo.webp', 'Facial cleanser with skin care formula from 14 premium traditional herbs helps clean the skin, while supporting the restoration of vitality, providing care solutions for skin with aging problems such as wrinkles, skin & dark color.'),
	(2, 'THE FACE SHOP All Clear Micellar Cleansing Oil Whip 250ml', 'fa4f5004-9bb6-4902-91e1-2bec1cc40610.webp', 'Able to remove dirt, stubborn makeup along with dirt deep inside pores, giving skin a healthy, naturally radiant glow.'),
	(3, 'Genuine Men''s CASIO Watch MDV-107-1A3', 'MDV-107-1A3V.webp', 'Take your all-metal analog style to the water. With water resistance up to 200 meters, a unidirectional rotating bezel and a screw-down case back, this is a watch that''s ready for any ocean sport or marine activity you throw your way. The sporty yet classic design also features a handy date display, providing practical convenience for a fashionable lifestyle.'),
